...
#undef OPTSTR_ls
#define OPTSTR_ls "(sort):(color):;(full-time)(block-size)#=1024<1(show-control-chars)?(group-directories-first)tZgoACFHLNRSUXabcdfhikl@mnpqrstuw#=80<0x1[-Cxm1][-Cxml][-Cxmo][-Cxmg][-cu][-ftS][-HL][-Nqb]"
#ifdef CLEANUP_ls
#undef CLEANUP_ls
#undef FOR_ls
#undef FLAG_1
